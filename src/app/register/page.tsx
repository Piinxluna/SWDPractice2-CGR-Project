...
export default function Component() {
  ...
  return (
    <main className='bg-white px-2 py-10 sm:px-10 md:px-16 lg:px-36 xl:px-72 2xl:px-96 min-h-screen'>
      <Card>
        <div className='py-8'><h1 className='text-4xl font-bold text-cgr-dark-green flex justify-center'>
        Register
        </h1>
        ...
        <div className='px-12 py-2'>
          ...
          <div className='flex flex-row mb-6 ml-8'>
            <p className='text-sm ml-12 mt-2 mb-6'>Already have an account ?
            <Link href="/login" className='text-sm ml-4 mt-2 text-cgr-dark-green'>
              Login</Link></p>
          </div>
        </div>
      </Card>
