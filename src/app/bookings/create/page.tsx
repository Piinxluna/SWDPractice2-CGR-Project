    ...
    <Card>
        ...
        <div className='text-lg gap-5 mb-8 flex flex-col ml-12'>
            <div className='flex flex-row mr-6'>
                <div className='w-1/3'><p className='font-medium text-l '>Campground Name:</p></div>
                <Select
            ...
            <div className='flex flex-row items-center mr-6'>
                <div className='w-1/3'><p className='font-medium'>Zone:</p></div>
                <Select
                    labelId="Zone"
                    id="zone"
                    value={zone}
            ...
            <div className='flex flex-row items-center mr-6'>
                <div className='w-1/3'><p className='font-medium'>Site Number:</p></div>
                <Select
                    labelId="Site Number"
                    id="sitenumber"
                    value={siteNumber}
            ...
            <div className='flex flex-row items-center mr-6'>
                <div className='w-1/3'><p className='font-medium'>Preferred Name:</p></div>
                <TextField
                    required
                    id='preferredName'
                    label='Name'
            ...
            <div className='flex flex-row items-center mr-6'>
                <div className='w-1/3'><p className='font-medium'>Amount:</p></div>
                <TextField
                    required
                    id='amount'
                    label='Amount'
            ...
            <div className='flex flex-row items-center mr-6'>
                <div className='w-1/3'><p className='font-medium'>Tent Size:</p></div>
                <TextField
                    required
                    id='tentSizeW'
                    label='Width(meter)'
            ...
            <div className='flex flex-row items-center mr-6'>
                <div className='w-1/3'><p className='font-medium'>Date:</p></div>
                <TextField
                    type='date'
                    id='date'
                    label='Date'
